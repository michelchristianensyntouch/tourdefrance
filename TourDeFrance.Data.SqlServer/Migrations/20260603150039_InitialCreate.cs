...
namespace TourDeFrance.Data.Migrations.SqlServer
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EtappeNummer = table.Column<int>(type: "int", nullable: false),
                    Datum = table.Column<DateOnly>(type: "date", nullable: true),
                    StartLocatie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EindLocatie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Afstand = table.Column<decimal>(type: "decimal(8,2)", nullable: true),
                    EtappeType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Startnummer = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RennerId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RennerId = table.Column<int>(type: "int", nullable: false),
                    AKPositie = table.Column<int>(type: "int", nullable: true),
                    PuntenPositie = table.Column<int>(type: "int", nullable: true),
                    BergPositie = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EtappeId = table.Column<int>(type: "int", nullable: false),
                    RennerId = table.Column<int>(type: "int", nullable: false),
        ...
        {
            migrationBuilder.DropTable(name: "DeelnemerSelecties");
            migrationBuilder.DropTable(name: "EindKlassementen");
            migrationBuilder.DropTable(name: "EtappeUitslagen");
            migrationBuilder.DropTable(name: "Deelnemers");
            migrationBuilder.DropTable(name: "Etappes");
            migrationBuilder.DropTable(name: "Renners");
            migrationBuilder.DropTable(name: "Ploegen");
        }
    }
}
